  ...
  const faqs = [
    {
      ...
      answer: "Workplace Mapping is our systematic approach to understanding how communication actually flows through your organization—not how it's supposed to work, but how it really works. We help organizations with distributed workforces build communication systems that reach everyone effectively.\n\nOur DISCOVER • ANALYZE • DESIGN • SUSTAIN methodology maps your communication reality and creates solutions that work with your actual workforce constraints, whether you have office workers, field staff, retail locations, manufacturing plants, or other distributed teams."
    },
    {
      question: "What makes this different from traditional communication consulting?",
      answer: "Most consultants survey employees about communication preferences and assume everyone works the same way. We actually investigate how messages travel through your organization by following real communications and mapping both formal and informal networks.\n\nWe recognize that office workers, hybrid employees, and field workers have fundamentally different communication needs and constraints. Our approach combines surveys (what people think is happening) with investigation (what's actually happening) to give you the complete picture."
    },
    {
    ...
    },
    {
      ...
      answer: "We build flexibility into our process to adapt as we learn more about your organization. If significant changes occur, we'll work with you to adjust our approach while staying focused on your core communication challenges.\n\nOur extended timelines allow for organizational changes and ensure thorough implementation that sticks."
    },
    {
    ...
    },
    {
      ...
      answer: "Our SUSTAIN phase (included in the complete process) includes training internal champions and building your organizational capability to maintain and evolve the communication systems we design together.\n\nWe also provide post-completion support for questions, and many organizations engage us for periodic check-ins or additional phases as they grow and change."
    },
    {
