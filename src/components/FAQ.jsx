...
<SafeIcon 
icon={FiChevronDown} 
className={`w-5 h-5 text-neutral-500 transition-transform duration-200 flex-shrink-0 ${openIndex===index ? 'transform rotate-180' : ''}`} 
/>
</button>
<AnimatePresence>
{openIndex===index && ( 
...
viewport={{once: true}} 
className="mt-12 text-center bg-primary-50 p-8 rounded-xl border border-primary-200" 
>
