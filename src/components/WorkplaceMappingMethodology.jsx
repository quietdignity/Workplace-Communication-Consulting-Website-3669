...
const {FiSearch, FiBarChart, FiSettings, FiRefreshCw, FiArrowRight, FiClock} = FiIcons;

const WorkplaceMappingMethodology = () => {
  const phases = [
    {
      number: "1",
      title: "DISCOVER",
  ...
  return (
    <section id="methodology" className="py-20 bg-gradient-to-br from-neutral-50 to-primary-50">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {phases.map((phase, index) => (
              ...
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${getColorClasses(phase.color)}`}>
                  {phase.number}
                </div>
                <SafeIcon icon={phase.icon} className="w-5 h-5 text-primary-600 group-hover:scale-110 transition-transform" />
                <span className="font-semibold text-primary-700">{phase.title}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
          ...
          <div className="bg-white p-8 rounded-xl border border-neutral-200 shadow-lg max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-neutral-600 mb-6">
                Explore our service options to see how we can implement this systematic approach for your organization's specific needs and timeline.
              </p>
...
export default WorkplaceMappingMethodology;