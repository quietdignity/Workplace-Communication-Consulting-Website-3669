      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-2xl text-neutral-700 mb-12 md:mb-16 max-w-4xl mx-auto leading-relaxed">
            Your messages reach headquarters and office locations effectively. But factory floor crews, retail associates, delivery drivers, field technicians, virtual teams, and distributed staff miss critical updates every day. We trace how information travels through your organization, then partner with you to build a communication infrastructure that's honest, malleable, and effective.
          </p>
          ...
          <div className="mt-12 md:mt-16 w-full">
            <div className="w-full text-center">
              <p className="text-xl md:text-2xl font-semibold text-neutral-700 mb-6 mx-auto">
                Or explore our systematic approach:
              </p>
            </div>
